...
const char *wifi_ssid = "LNA";
const char *wifi_password = "Tacos2021";
...
const char *client_id = "TD06_GP04";
...
void setup()
{
  ...
  {
    mqtt_client.publish("TD06_GP04/temp", String(temp_measure).c_str());
    mqtt_client.publish("TD06_GP04/relhum",String( relative_humidity_measure).c_str());
  }
